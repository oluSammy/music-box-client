  ...
  return (
    <div className={classes.recommended}>
      <div className={classes.recommendedHeading}>
        <Button variant="outlined" className={classes.recommendedBtn}>REFRESH</Button>
      ...
      <div className={classes.recommendedTableHeading}>
        ...
        <p className={clsx(classes.title, classes.removeMobile)}>
          David Bowie
        </p>
        ...
        <div className={clsx(classes.recommendedFlexEnd, classes.title)}>
          <Button
            variant="outlined"
            className={classes.recommendedBtn}
